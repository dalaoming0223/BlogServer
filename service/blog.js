...
async function add_blog(req, res) {
    ...
    try {
        ...
        // console.log('创建时间和更新时间：',created_at, updated_at)

        let blog = await Blog.create({ //TODO: 这里有bug
            title, content, desc, state, origin, created_at, updated_at, uuid, user_id, category_id
        })
        console.log('能到这里不')
